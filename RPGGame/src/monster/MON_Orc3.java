...
public class MON_Orc3 extends Entity{
    
    GamePanel gp;
    int numOfTiles;
    
    public MON_Orc3(GamePanel gp) {
        super(gp);
    ...
    public void getImage(){
        ...
        up0 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        up1 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        up2 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        down0 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        down1 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        down2 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        left0 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        left1 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        left2 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        right0 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        right1 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
        right2 = setup("/monster/testing", gp.tileSize * numOfTiles, gp.tileSize * numOfTiles);
    }
