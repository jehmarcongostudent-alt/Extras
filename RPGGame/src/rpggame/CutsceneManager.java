...
public class CutsceneManager {
    ...
    public void scene_ending(){
        ...
        if(scenePhase == 0){
            ...
            gp.stopMusic();
            gp.ui.npc = new OBJ_LegendaryItem(gp);
            scenePhase++;
        }
        if(scenePhase == 1){
        ...
        if(scenePhase == 3){
            ...
            if(counterReached(60*5) == true || gp.keyH.ConfirmPressed()){
                scenePhase++;
            }
        }
        if(scenePhase == 4){
            ...
            if(alpha == 1f || gp.keyH.ConfirmPressed()){
                alpha = 0;
                scenePhase++;
            }
        }
        if(scenePhase == 5){
            ...
            String text = "After the fierce battle with the ancient Golem, \n"
                    + "the hero finaly found a legendary treasure. \n"
                    + "But this is not the end of this journey. \n"
                    + "For there are more Treasures to come.";
            drawString(alpha, 38f, 200, text, 70);
            
            if(counterReached(600) == true || gp.keyH.ConfirmPressed()){
                scenePhase++;
            }
        }
        if(scenePhase == 6){
            ...
            drawString(1f, 120f, gp.screenHeight/2, "2D Game", 40);
            
            if(counterReached(60*8) == true || gp.keyH.ConfirmPressed()){
                scenePhase++;
            }
        }
        if(scenePhase == 7){
        ...
        if(scenePhase == 8){    
            ...
            if(counterReached(60*15) == true || gp.keyH.ConfirmPressed()){
                scenePhase++;
            }
        }
        if(scenePhase == 9){
